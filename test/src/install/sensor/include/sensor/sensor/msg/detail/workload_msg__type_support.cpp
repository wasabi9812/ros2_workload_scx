...
{
  new (message_memory) sensor::msg::WorkloadMsg(_init);
}

void WorkloadMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sensor::msg::WorkloadMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WorkloadMsg_message_member_array[7] = {
  {
    ...
    offsetof(sensor::msg::WorkloadMsg, seq),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor::msg::WorkloadMsg, profile),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor::msg::WorkloadMsg, encoding),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor::msg::WorkloadMsg, width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor::msg::WorkloadMsg, height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor::msg::WorkloadMsg, element_size),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor::msg::WorkloadMsg, payload),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::sensor::msg::rosidl_typesupport_introspection_cpp::WorkloadMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor, msg, WorkloadMsg)() {
  return &::sensor::msg::rosidl_typesupport_introspection_cpp::WorkloadMsg_message_type_support_handle;
}

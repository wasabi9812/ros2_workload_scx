...
{
  new (message_memory) workload_nodes::msg::WorkloadMsg(_init);
}

void WorkloadMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<workload_nodes::msg::WorkloadMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WorkloadMsg_message_member_array[7] = {
  {
    ...
    offsetof(workload_nodes::msg::WorkloadMsg, seq),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(workload_nodes::msg::WorkloadMsg, profile),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(workload_nodes::msg::WorkloadMsg, encoding),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(workload_nodes::msg::WorkloadMsg, width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(workload_nodes::msg::WorkloadMsg, height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(workload_nodes::msg::WorkloadMsg, element_size),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(workload_nodes::msg::WorkloadMsg, payload),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WorkloadMsg_message_members = {
  "workload_nodes::msg",  // message namespace
  "WorkloadMsg",  // message name
  7,  // number of fields
  sizeof(workload_nodes::msg::WorkloadMsg),
...
{
  return &::workload_nodes::msg::rosidl_typesupport_introspection_cpp::WorkloadMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, workload_nodes, msg, WorkloadMsg)() {
  return &::workload_nodes::msg::rosidl_typesupport_introspection_cpp::WorkloadMsg_message_type_support_handle;
}

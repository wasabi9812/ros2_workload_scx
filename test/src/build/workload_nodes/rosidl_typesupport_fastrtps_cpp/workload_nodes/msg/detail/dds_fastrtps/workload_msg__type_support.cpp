...
#include "workload_nodes/msg/detail/workload_msg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = workload_nodes::msg::WorkloadMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const workload_nodes::msg::WorkloadMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<workload_nodes::msg::WorkloadMsg *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_workload_nodes
const rosidl_message_type_support_t *
get_message_type_support_handle<workload_nodes::msg::WorkloadMsg>()
{
  return &workload_nodes::msg::typesupport_fastrtps_cpp::_WorkloadMsg__handle;
}

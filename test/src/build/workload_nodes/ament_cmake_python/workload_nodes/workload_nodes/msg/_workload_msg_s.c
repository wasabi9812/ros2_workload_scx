...
bool workload_nodes__msg__workload_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("workload_nodes.msg._workload_msg.WorkloadMsg", full_classname_dest, 44) == 0);
  }
  workload_nodes__msg__WorkloadMsg * ros_message = _ros_message;
  {  // seq
...
PyObject * workload_nodes__msg__workload_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("workload_nodes.msg._workload_msg");

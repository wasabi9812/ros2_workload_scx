...
sensorpackage__msg__WorkloadMsg__init(sensorpackage__msg__WorkloadMsg * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->profile)) {
    sensorpackage__msg__WorkloadMsg__fini(msg);
    return false;
  }
  // encoding
...
sensorpackage__msg__WorkloadMsg__create(void)
{
  ...
  sensorpackage__msg__WorkloadMsg * msg = (sensorpackage__msg__WorkloadMsg *)allocator.allocate(sizeof(sensorpackage__msg__WorkloadMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sensorpackage__msg__WorkloadMsg));
  bool success = sensorpackage__msg__WorkloadMsg__init(msg);
  if (!success) {
...
sensorpackage__msg__WorkloadMsg__Sequence__init(sensorpackage__msg__WorkloadMsg__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensorpackage__msg__WorkloadMsg * data = NULL;

  if (size) {
    data = (sensorpackage__msg__WorkloadMsg *)allocator.zero_allocate(size, sizeof(sensorpackage__msg__WorkloadMsg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sensorpackage__msg__WorkloadMsg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sensorpackage__msg__WorkloadMsg__fini(&data[i - 1]);
      }
...
sensorpackage__msg__WorkloadMsg__Sequence__fini(sensorpackage__msg__WorkloadMsg__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sensorpackage__msg__WorkloadMsg__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensorpackage__msg__WorkloadMsg__Sequence * array = (sensorpackage__msg__WorkloadMsg__Sequence *)allocator.allocate(sizeof(sensorpackage__msg__WorkloadMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sensorpackage__msg__WorkloadMsg__Sequence__init(array, size);
  if (!success) {
...
sensorpackage__msg__WorkloadMsg__Sequence__destroy(sensorpackage__msg__WorkloadMsg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sensorpackage__msg__WorkloadMsg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sensorpackage__msg__WorkloadMsg__Sequence__are_equal(const sensorpackage__msg__WorkloadMsg__Sequence * lhs, const sensorpackage__msg__WorkloadMsg__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sensorpackage__msg__WorkloadMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sensorpackage__msg__WorkloadMsg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sensorpackage__msg__WorkloadMsg);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sensorpackage__msg__WorkloadMsg * data =
      (sensorpackage__msg__WorkloadMsg *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sensorpackage__msg__WorkloadMsg__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sensorpackage__msg__WorkloadMsg__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sensorpackage__msg__WorkloadMsg__copy(

...
#include "sensorpackage/msg/detail/workload_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sensorpackage
cdr_serialize(
  const sensorpackage::msg::WorkloadMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sensorpackage::msg::WorkloadMsg & ros_message)
{
  // Member: seq
  cdr >> ros_message.seq;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensorpackage::msg::WorkloadMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensorpackage::msg::WorkloadMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensorpackage::msg::WorkloadMsg *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_sensorpackage
const rosidl_message_type_support_t *
get_message_type_support_handle<sensorpackage::msg::WorkloadMsg>()
{
  return &sensorpackage::msg::typesupport_fastrtps_cpp::_WorkloadMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensorpackage, msg, WorkloadMsg)() {
  return &sensorpackage::msg::typesupport_fastrtps_cpp::_WorkloadMsg__handle;
}

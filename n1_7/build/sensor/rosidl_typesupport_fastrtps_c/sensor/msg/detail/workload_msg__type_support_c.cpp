...
#include "sensor/msg/detail/workload_msg__rosidl_typesupport_fastrtps_c.h"
...
using _WorkloadMsg__ros_msg_type = sensor__msg__WorkloadMsg;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor__msg__WorkloadMsg;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sensor__msg__WorkloadMsg * ros_message = static_cast<const sensor__msg__WorkloadMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sensor__msg__WorkloadMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sensor__msg__WorkloadMsg * ros_message = static_cast<sensor__msg__WorkloadMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sensor__msg__WorkloadMsg(cdr, ros_message);
}

static uint32_t _WorkloadMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sensor__msg__WorkloadMsg(
...
static size_t _WorkloadMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sensor__msg__WorkloadMsg(
